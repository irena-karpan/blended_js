...
// let num = Number(prompt('Введіть значення від 1 до 4 включно'));
// switch (num) {
//     case 1:
//         alert("Зима");
//         break;
...
// const a = Number(prompt('min:'));
// const b = Number(prompt('max:'));
// console.log(getNumbers(a, b));
